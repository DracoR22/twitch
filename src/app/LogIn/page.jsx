  ...
  return (
    <div className=' flex items-center justify-center h-screen'>
     ...
     <div className='flex justify-center mt-12'>
        ...
        <p className='font-bold text-3xl pl-3 pt-4'>Log in to Twitch</p>
     </div>
     <div className='mt-10 mx-8'>
        ...
        <form >
         ...
         <div className='flex justify-center mt-12 mx-8'>
           <button className='bg-[#5c16c5] text-white font-bold h-12 w-full rounded-md'>Log In</button>
         </div>
            <div className='mt-12 mx-8 flex justify-center'>
               <p className='text-[#bf94ff] font-bold'>Don't have an account?</p>
             <Link href='/SignUp'> <p className='text-[#bf94ff] font-bold pl-1'> Sign Up</p> </Link> 
            </div>
     </div>
    </div>
  )
